...
*/
  ...
  class CLEAR_DATA_INDEX
    ...
    static $data_indexes = "C:\\xampp\\htdocs\\proxior\\index.htmh";
    public $data_index;
...
// clone class pc file for delete
  ...
  class CLEAR_DATA_PC
    ...
    static $data_pcs = "C:\\xampp\\htdocs\\proxior\\pc.htmh";
    public $data_pc;
...
// clone class mobile file for delete
  ...
  class CLEAR_DATA_MOBILE
    ...
    static $data_mobiles = "C:\\xampp\\htdocs\\proxior\\mobile.htmh";
    public $data_mobile;
  ...
  $obj_data_mobile -> data_mobile_c2 = new CLEAR_DATA_MOBILE();
   ...
   class CLEAR_DATA_POST
    ...
    static $data_posts = "C:\\xampp\\htdocs\\proxior\\post.phl";
    public $data_post;
 ...
 // clone class txt file for delete
   ...
   class CLEAR_DATA_TXT
    ...
    static $data_txts = "C:\\xampp\\htdocs\\proxior\\export\\data.txp";
    public $data_txt;
 ...
 // clone class win.bat file for delete
   ...
   class CLEAR_DATA_BAT
    ...
    static $data_bats = "C:\\xampp\\htdocs\\proxior\\export\\l_win.bap";
    public $data_bat;
